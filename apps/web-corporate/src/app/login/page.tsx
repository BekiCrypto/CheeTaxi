    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-50 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 flex items-center justify-center gap-2">
          ...
          <span className="text-2xl font-bold text-ink-900">CheeTaxi Corporate</span>
        </div>
        <form onSubmit={onSubmit} className="card space-y-4 p-8">
          <div>
            ...
            <input type="text" className="input" value={identifier} onChange={(e) => setIdentifier(e.target.value)} required />
          </div>
          <div>
        ...
        <p className="mt-4 text-center text-xs text-ink-500">For fleet managers and corporate partners</p>
      </div>
    </div>
  );
}
